<x-layouts.admin title="Tambah Artikel Baru">
    ...
    >
        ...
        <button 
            type="button" 
            @click="open = !open" 
            class="w-full border border-black rounded-md px-3 py-2 flex justify-between items-center text-left bg-[#d6f6e4] dark:border-black dark:text-black"
        >
        ...
        >
            <template x-for="option in options" :key="option.value">
                ...
                <div>
                    ...
                    <input id="thumbnail" type="file" name="thumbnail" accept="image/*" class="w-full text-sm font-semibold text-gray-500 file:mr-3 file:border-0 file:bg-[#d6f6e4] file:text-gray-700 dark:file:bg-[#d6f6e4] dark:file:text-black file:px-4 file:py-2 file:rounded-md hover:file:bg-gray-300 dark:hover:file:bg-gray-200">
                </div>
            </div>
