        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-10">
            ...
            <div class="col-span-2 space-y-4">
                <div class="flex items-center gap-4">
                    <a href="/">
                    <img src="{{ asset('assets/images/logo-gizi.png') }}" alt="GIZILA" class="h-14 relative -top-4 object-contain">
                </a>
                    <h3 class="font-bold relative -top-2 object-contain text-sm uppercase mb-3">HUBUNGI KAMI</h3>
